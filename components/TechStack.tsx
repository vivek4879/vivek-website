      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((cat) => (
            <div
              key={cat.label}
              className="group rounded-2xl border border-border bg-surface p-6 transition-all duration-300 hover:border-cyan/30 hover:shadow-[0_0_30px_-5px] hover:shadow-cyan/10"
            >
              {/* Category label */}
              <p
